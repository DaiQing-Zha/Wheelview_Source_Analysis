...
package lvbu.wang.wheelview_source_analysis.wheel.views;
...
import lvbu.wang.wheelview_source_analysis.utils.DensityUtil;
import lvbu.wang.wheelview_source_analysis.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		int width = itemsLayout.getMeasuredWidth();	//获取控件的原始大小
